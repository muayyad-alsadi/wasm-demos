...
class FastMemory:
    ...
    def _get_set_item_common(self, key: Union[int, slice], value: Union[bytearray, array.array] = None):
        ...
        return None, (data_ptr, start, stop, step)

    def __getitem__(self, key: Union[int, slice]):
        """
        provide memory[offset] or memory[start:stop]
        """
        ret, details = self._get_set_item_common(key)
        if details is None:
            return ret
        data_ptr, start, stop, step = details
    ...
    def __setitem__(self, key: Union[int, slice], value: Union[bytearray, array.array]):
        ...
        """
        ret, details = self._get_set_item_common(key, value)
        if details is None:
            return ret
        data_ptr, start, stop, step = details
        # this is tested with [1:4:2]
